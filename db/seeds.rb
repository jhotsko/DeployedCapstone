...
more_cadets = [ {:lastName =>'Nye', :firstName => 'Olivia', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet Wing Commander', :course => 'AS400', :gradYear => 2020 , :flight => 'Alpha', :username => 'onye', :password => 'password', :approved => true},
    {:lastName =>'Juenemann', :firstName => 'Riley', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Operations Group Commander', :course => 'AS400', :gradYear => 2020 , :flight => 'Bravo', :username => 'rjuenemann', :password => 'password', :approved => true},
    {:lastName =>'Dorsey', :firstName => 'Kennedy', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Mission Support Group Commander', :course => 'AS400', :gradYear => 2020, :flight => 'Alpha', :username => 'kdorsey3', :password => 'password', :approved => true},
    {:lastName => 'Hotsko', :firstName => 'Jessica', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Squadron Commander', :course => 'AS400', :gradYear => 2020, :flight => 'Bravo', :username => 'jhotsko',:password => 'password', :approved => true},
    {:lastName =>'Dewitt', :firstName => 'Marie', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Alpha Flight Commander', :course => 'AS300', :gradYear => 2020 , :flight => 'Alpha', :username => 'mdewitt', :password => 'password', :approved => true},
    {:lastName =>'Clark', :firstName => 'Kyra', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Bravo Flight Commander', :course => 'AS300', :gradYear => 2021 , :flight => 'Bravo', :username => 'kclark7', :password => 'password', :approved => true},
    {:lastName =>'Westlake', :firstName => 'Alexa', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Deputy Squadron Commander', :course => 'AS300', :gradYear => 2021 , :flight => 'Alpha', :username => 'awestlak', :password => 'password', :approved => true},
    {:lastName => 'Wells', :firstName => 'Rachel', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'MWR Officer', :course => 'AS300', :gradYear => 2021 , :flight => 'Bravo', :username => 'rwells3', :password => 'password', :approved => true},
    {:lastName => 'Kurdia', :firstName => 'Anastasia', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'GMCA', :course => 'AS200', :gradYear => 2022 , :flight => 'Alpha', :username => 'akurdia', :password => 'password', :approved => true},    
    {:lastName => 'Anne', :firstName => 'Carri', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS200', :gradYear => 2022 , :flight => 'Bravo', :username => 'canne', :password => 'password', :approved => true},
    {:lastName => 'Edward', :firstName => 'Nathan', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS200', :gradYear => 2022, :flight => 'Alpha', :username => 'nedward', :password => 'password', :approved => true},
    {:lastName => 'Paige', :firstName => 'Allyson', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS200', :gradYear => 2022, :flight => 'Bravo', :username => 'apaige', :password => 'password', :approved => true},
    {:lastName => 'Edward', :firstName => 'Joseph', :email => 'rotseetest@gmail.com', :phoneNumber => '111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS250', :gradYear => 2022, :flight => 'Alpha', :username => 'jbildstein', :password => 'password', :approved => true},
    {:lastName => 'Grant', :firstName => 'Daniel', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS250', :gradYear => 2022, :flight => 'Bravo', :username => 'dgrant', :password => 'password', :approved => true},
    {:lastName => 'Elliot', :firstName => 'Mason', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS250', :gradYear => 2022, :flight => 'Alpha', :username => 'melliot', :password => 'password', :approved => true},
    {:lastName => 'Louise', :firstName => 'Jaime', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS100', :gradYear => 2023, :flight => 'Bravo', :username => 'jlouise', :password => 'password', :approved => true},
    {:lastName => 'James', :firstName => 'Landon', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS100', :gradYear => 2023, :flight => 'Alpha', :username => 'ljames', :password => 'password', :approved => true},
    {:lastName => 'Ryan', :firstName => 'Chase', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS100', :gradYear => 2023, :flight => 'Bravo', :username => 'cryan', :password => 'password', :approved => true},
    {:lastName => 'Day', :firstName => 'Jessica', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS100', :gradYear => 2023, :flight => 'Alpha', :username => 'jday', :password => 'password', :approved => true},
    {:lastName => 'Miller', :firstName => 'Nicholas', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS100', :gradYear => 2023, :flight => 'Bravo', :username => 'nmiller', :password => 'password', :approved => true},
    {:lastName => 'McDonald', :firstName => 'Travis', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS100', :gradYear => 2022, :flight => 'Bravo', :username => 'tmcdonald', :password => 'password', :approved => false},
    {:lastName => 'Doerr', :firstName => 'Jay', :email => 'rotseetest@gmail.com', :phoneNumber => '1111111111', :school => 'Tulane University', :position => 'Cadet', :course => 'AS100', :gradYear => 2023, :flight => 'Bravo', :username => 'jdoerr', :password => 'password', :approved => false}]
    
more_cadets.each do |cadet|
    Cadet.create!(cadet)
end

more_events =  [ {:eventDate => Date.new(2019, 12, 17), :primaryType => "PT", :subType => "Strength Workout", :details => "Bench 3 sets of 10 reps" }, 
...
{:eventDate => Date.new(2019, 12, 10), :primaryType => "PT", :subType => "Strength Workout", :details => "Squat 5 sets of 5 reps"},
...
{:eventDate => Date.new(2019, 12, 3), :primaryType => "PT", :subType => "Strength Workout", :details => "PR day"},
...
{:eventDate => Date.new(2019, 10, 17), :primaryType => "PT", :subType => "Strength Workout", :details => "Upper body workout of your choice" }, 
...
{:eventDate => Date.new(2019, 10, 10), :primaryType => "PT", :subType => "Strength Workout", :details => "Details"},
...
{:eventDate => Date.new(2019, 10, 3), :primaryType => "PT", :subType => "Strength Workout", :details => "Details"},
...
{:eventDate => Date.new(2019, 9, 26), :primaryType => "PT", :subType => "Strength Workout", :details => "Details"},
...
{:eventDate => Date.new(2019, 9, 19), :primaryType => "PT", :subType => "Strength Workout", :details => "Details"},
...
{:eventDate => Date.new(2019, 9, 12), :primaryType => "PT", :subType => "Strength Workout", :details => "Details"},
...
{:eventDate => Date.new(2019, 9, 5), :primaryType => "PT", :subType => "Strength Workout", :details => "Details"},
